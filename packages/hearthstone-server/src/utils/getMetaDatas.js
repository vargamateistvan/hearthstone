...
module.exports = {
    getCardSets: async () => {
        ...
        fs.writeFile('./data/sets.json', JSON.stringify(result), (err) => {
    ...
    getCardClasses: async () => {
        ...
        fs.writeFile('./data/classes.json', JSON.stringify(result), (err) => {
            if (err) return console.error(err);
    ...
    getCardRarities: async () => {
        ...
        fs.writeFile('./data/rarities.json', JSON.stringify(result), (err) => {
            if (err) return console.error(err);
    ...
    getCardTypes: async () => {
        ...
        fs.writeFile('./data/types.json', JSON.stringify(result), (err) => {
            if (err) return console.error(err);
